...
export const updatePanelContent = (contentContainer, wonder) => {
  ...
  if (wonder.wikiLink) {
    ...
    wikiA.href = wonder.wikiLink;
    wikiA.className = 'info-wiki-link';
    wikiA.target = '_blank';
    wikiA.rel = 'noopener noreferrer';
    wikiA.innerHTML =
      'Read more on Wikipedia <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>';
    textContent.appendChild(wikiA);
  }
